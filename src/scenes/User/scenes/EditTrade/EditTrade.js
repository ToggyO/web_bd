  ...
  <div className="paper">
    <div className="edit-trade">
      ...
      <p>
        ...
        ex, atque amet nihil neque fugiat expedita dolorem quam deserunt eligendi pariatur
        odit vitae tempore, tempora assumenda debitis ipsam, minima fugit. Sapiente
        perspiciatis, adipisci praesentium, debitis ipsa amet totam minus!
      </p>
      <EditTradeForm />
    </div>
  </div>
