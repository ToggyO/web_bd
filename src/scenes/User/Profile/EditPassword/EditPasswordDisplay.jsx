  ...
  <AppWrapperContainer>
    <div className="paper">
      <div className="change-setting">
        ...
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium, ipsam quod!
          Blanditiis quo eius vero earum nemo perferendis laudantium corrupti cupiditate! Eum
          voluptas aperiam minima sequi voluptatibus harum, omnis corrupti.
        </p>
