                ...
                switch (specificTrade.status) {
                  ...
                  case 'Depositing':
                    if (me === 'buyer') {
                      return (
                        <ExclamationMessage>
                          Waiting for <Link to={`${ROUTES.USERS.ROOT}/${user}`}>{user}</Link> to deposit funds
                          to Escrow.
                        </ExclamationMessage>
                      );
                    }
          ...
          <Col md={{ span: 12, order: 2 }} xs={{ span: 24, order: 1 }}>
            <Spin spinning={loading} indicator={<Spinner />}>
              <p>
                ...
                notification when the seller reply. You can open the window of this trade from you
