export const INITIATE_REQUEST = 'bitcoins-direct/trades/trade/INITIATE_REQUEST';
export const INITIATE_SUCCESS = 'bitcoins-direct/trades/trade/INITIATE_SUCCESS';
export const INITIATE_ERROR = 'bitcoins-direct/trades/trade/INITIATE_ERROR';

export const GET_BY_ID_REQUEST = 'bitcoins-direct/trades/trade/GET_BY_ID_REQUEST';
export const GET_BY_ID_SUCCESS = 'bitcoins-direct/trades/trade/GET_BY_ID_SUCCESS';
export const GET_BY_ID_ERROR = 'bitcoins-direct/trades/trade/GET_BY_ID_ERROR';
