          ...
          <AppWrapperContainer {...mainProps}>
            <Switch>
              ...
              <Route
                path={ROUTES.ADS.BUY}
                exact
                component={props => <AdsContainer {...props} type="sell" />}
              />
              <Route
                path={ROUTES.ADS.SELL}
                exact
                component={props => <AdsContainer {...props} type="buy" />}
              />
              <Route
              ...
              />
              <AuthRoute
                path={ROUTES.TRADES.TRADE}
                exact
                component={props => <TradeContainer {...props} />}
              />
